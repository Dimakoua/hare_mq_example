...
config :hare_mq_example, HareMqExampleWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "pAYBP0QJH+p/0yM9bj2QvMlYgv1d70aqkm3+mUI6+zHvPeKlkBCdbZxRtpU7tvnl",
  watchers: []
...
config :hare_mq_example, HareMqExampleWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/hare_mq_example_web/router\.ex$",
      ~r"lib/hare_mq_example_web/(controllers|live|components)/.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :hare_mq_example, dev_routes: true
